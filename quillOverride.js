function addFormulaBtnToToolbar(toolbar) {
  /* Override Quill toolbar to include a native formula button, for every text box on the page */

  // Check if the toolbar exists
  if (!toolbar) return;
  
  // Prevent duplicate button
  if (toolbar.querySelector('.ql-formula')) return;

  // Create the formula button 
  ...
  // Placing button on toolbar besides code block 
